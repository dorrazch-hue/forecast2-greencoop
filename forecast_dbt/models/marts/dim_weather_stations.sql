...
-- CORRECTION (conformité énoncé) :
-- 1. L'énoncé distingue Hardware ("other") et Software ("EasyWeatherPro_V5.1.6") :
--    le projet mettait le software dans la colonne hardware. Ajout d'une colonne software.
-- 2. Station Name officiel de IICHTE19 = "WeerstationBS" (pas "Ichtegem").
...
with stations as (
    ...
    select 'bergues' as station_key, '000R5' as station_id, 'Bergues' as station_name,
           ...
           'France' as city, null as state, 'infoclimat' as network,
           'StatIC' as hardware, null as software
    ...
    select 'lille_lesquin' as station_key, '07015' as station_id, 'Lille-Lesquin' as station_name,
           ...
           'Lille' as city, null as state, 'infoclimat' as network,
           'SYNOP' as hardware, null as software
    ...
    select 'la_madeleine' as station_key, 'ILAMAD25' as station_id, 'La Madeleine' as station_name,
           ...
           'La Madeleine' as city, null as state, 'weather_underground' as network,
           'other' as hardware, 'EasyWeatherPro_V5.1.6' as software
    ...
    select 'ichtegem' as station_key, 'IICHTE19' as station_id, 'WeerstationBS' as station_name,
           ...
           'Ichtegem' as city, null as state, 'weather_underground' as network,
           'other' as hardware, 'EasyWeatherV1.6.6' as software
